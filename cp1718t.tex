...
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment verificar que implementações estão corretas com exemplos}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{getTransactions}\mathbin{::}\Conid{Block}\to \Conid{Transactions}{}\<[E]%
\\
\>[B]{}\Varid{getTransactions}\mathrel{=}\p2\comp \p2{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{allTransactions}\mathrel{=}\Varid{cataBlockchain}\;\alt{\Varid{getTransactions}}{\mathsf{conc}\comp (\Varid{getTransactions}\times\Varid{id})}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{f}\;(e_1 ,(\Varid{v},e_2 ))\mathrel{=}(e_1 ,\mathbin{-}\Varid{v})\mathbin{:}(e_2 ,\Varid{v})\mathbin{:}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{nwCell}\;(\Conid{Cell}\;\Varid{a}\;\Varid{x}\;\Varid{y})\mathrel{=}\Conid{Cell}\;\Varid{a}\;\Varid{x}\;\Varid{y}{}\<[E]%
\\
\>[B]{}\Varid{nwCell}\;(\Conid{Block}\;\Varid{nw}\;\Varid{ne}\;\Varid{se}\;\Varid{sw})\mathrel{=}\Varid{nwCell}\;\Varid{nw}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  implementar com combinadores}{}\<[E]%
\\
\>[B]{}\Varid{compressQTree}\;\Varid{n}\;(\Conid{Block}\;\Varid{nw}\;\Varid{ne}\;\Varid{se}\;\Varid{sw})\mathrel{=}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{if}\;(\Varid{n}\mathbin{>}\mathrm{0}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{then}\;\Conid{Block}\;(\Varid{cT}\;(\Varid{n}\mathbin{-}\mathrm{1})\;\Varid{nw})\;(\Varid{cT}\;(\Varid{n}\mathbin{-}\mathrm{1})\;\Varid{ne})\;(\Varid{cT}\;(\Varid{n}\mathbin{-}\mathrm{1})\;\Varid{se})\;(\Varid{cT}\;(\Varid{n}\mathbin{-}\mathrm{1})\;\Varid{sw}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{else}\;\Varid{nwCell}\;\Varid{nw}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\mathbf{where}\;\Varid{cT}\mathrel{=}\Varid{compressQTree}{}\<[E]%
\\
\>[B]{}\Varid{compressQTree}\;\Varid{n}\;(\Conid{Cell}\;\Varid{a}\;\Varid{x}\;\Varid{y})\mathrel{=}\Conid{Cell}\;\Varid{a}\;\Varid{x}\;\Varid{y}{}\<[E]%
\\[\blanklineskip]%
