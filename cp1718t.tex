...
\xymatrix@C=2cm{
    \ensuremath{\Conid{Blockchain}}
           \ar[d]_-{allTransactions = \ensuremath{\cata{\Varid{g}}}}
&
...
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  implementar com combinadores}{}\<[E]%
\\
\>[B]{}\Varid{ledger}\mathrel{=}(\Varid{cataList}\;\alt{\Varid{nil}}{\Varid{put}})\comp (\Varid{cataList}\;\alt{\Varid{nil}}{\mathsf{conc}\comp (\Varid{f}\times\Varid{id})})\comp \Varid{allTransactions}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{f}\mathbin{::}\Conid{Transaction}\to [\mskip1.5mu \Conid{Cashflow}\mskip1.5mu]{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
...
\\
\>[B]{}\Varid{allMagicNos}\mathrel{=}\Varid{cataBlockchain}\;\alt{\Varid{singl}\comp \Varid{getMagicNo}}{\Varid{cons}\comp (\Varid{getMagicNo}\times\Varid{id})}{}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{isValidMagicNr}\mathrel{=}\neg \comp (\Varid{any}\;\Varid{belongs})\comp (\Varid{anaList}\;((\Varid{id}+\conj{\Varid{id}}{\p2})\comp \Varid{outList}))\comp \Varid{allMagicNos}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment rotateCell (a, (x, y)) = (a, (y, x))}{}\<[E]%
\\
\>[B]{}\Varid{rotateCell}\mathrel{=}\Varid{id}\times\Varid{swap}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment rotateBlock (nw, (ne, (sw, se))) = (sw, (nw, (se, ne)))}{}\<[E]%
\\
\>[B]{}\Varid{rotateBlock}\mathrel{=}\conj{\p1\comp \p2\comp \p2}{\conj{\p1}{\conj{\p2\comp \p2\comp \p2}{\p1\comp \p2}}}{}\<[E]%
\\
\>[B]{}\Varid{rotateQTree}\mathrel{=}\Varid{anaQTree}\;((\Varid{rotateCell}+\Varid{rotateBlock})\comp \Varid{outQTree}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{scaleCell}\;\Varid{k}\;(\Conid{Cell}\;\Varid{a}\;\Varid{x}\;\Varid{y})\mathrel{=}\Varid{outQTree}\;(\Conid{Cell}\;\Varid{a}\;(\Varid{x}\mathbin{*}\Varid{k})\;(\Varid{y}\mathbin{*}\Varid{k})){}\<[E]%
\\
\>[B]{}\Varid{scaleCell}\;\anonymous \;\Varid{b}\mathrel{=}\Varid{outQTree}\;\Varid{b}{}\<[E]%
\\
\>[B]{}\Varid{scaleQTree}\;\Varid{k}\mathrel{=}\Varid{anaQTree}\;(\Varid{scaleCell}\;\Varid{k}){}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{nwCell}\;(\Conid{Block}\;\Varid{nw}\;\Varid{ne}\;\Varid{sw}\;\Varid{se})\;\Varid{i}\;\Varid{j}\mathrel{=}\Varid{nwCell}\;\Varid{nw}\;(\Varid{i}\mathbin{+}\Varid{x2})\;(\Varid{j}\mathbin{+}\Varid{y3}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;(\Conid{Cell}\;\anonymous \;\Varid{x2}\;\anonymous )\mathrel{=}\Varid{nwCell}\;\Varid{ne}\;\mathrm{0}\;\mathrm{0}{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}(\Conid{Cell}\;\anonymous \;\anonymous \;\Varid{y3})\mathrel{=}\Varid{nwCell}\;\Varid{sw}\;\mathrm{0}\;\mathrm{0}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  implementar com combinadores}{}\<[E]%
\\
...
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{if}\;(\Varid{n}\geq \mathrm{0}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{outlineBlock}\;\Varid{x}\;\Varid{y}\mathrel{=}\Conid{Block}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{outlineCell}\;\Varid{p}\;(\Varid{a},(\Varid{x},\Varid{y}))\mathrel{=}\Varid{cond}\;\Varid{p}\;\underline{(\Varid{outlineBlock}\;\Varid{x}\;\Varid{y})}\;\underline{(\Conid{Cell}\;\Conid{False}\;\Varid{x}\;\Varid{y})}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{outlineQTreeAux}\;\Varid{p}\mathrel{=}\Varid{cataQTree}\;\alt{\Varid{outlineCell}\;\Varid{p}}{\Varid{inQTree}\comp i_2}{}\<[E]%
\\[\blanklineskip]%
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mbox{\onelinecomment  Converter as definições de fk, lk, g e s para a forma da regra 50 e aplicar a regra 51 a <fk,lk> e <g,s>}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  Igualar o resultado anterior ao catamorfismo do for e retirar a definição de base e loop}{}\<[E]%
\\
\>[B]{}\Varid{base}\mathrel{=}\Varid{tuploaux}\comp \conj{\conj{\underline{\mathrm{1}}}{\mathbin{+}\mathrm{1}}}{\conj{\underline{\mathrm{1}}}{\underline{\mathrm{1}}}}{}\<[E]%
\\
\>[B]{}\Varid{loop}\mathrel{=}\Varid{tuploaux}\comp \conj{\conj{\Varid{mul}\comp \p1}{\succ \comp \p2\comp \p1}}{\conj{\Varid{mul}\comp \p2}{\succ \comp \p2\comp \p2}}\comp \Varid{paresaux}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  Funções auxiliar para conversão de tipos}{}\<[E]%
\\
\>[B]{}\Varid{tuploaux}\mathbin{::}((\Conid{Integer},\Conid{Integer}),(\Conid{Integer},\Conid{Integer}))\to (\Conid{Integer},\Conid{Integer},\Conid{Integer},\Conid{Integer}){}\<[E]%
\\
\>[B]{}\Varid{tuploaux}\;((\Varid{x},\Varid{y}),(\Varid{w},\Varid{z}))\mathrel{=}(\Varid{x},\Varid{y},\Varid{w},\Varid{z}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{paresaux}\mathbin{::}(\Conid{Integer},\Conid{Integer},\Conid{Integer},\Conid{Integer})\to ((\Conid{Integer},\Conid{Integer}),(\Conid{Integer},\Conid{Integer})){}\<[E]%
\\
...
\just\equiv{ Eq-+ }
%
\ensuremath{\alt{\Varid{f}\;\Varid{k}\comp \underline{\mathrm{0}}}{\Varid{f}\;\Varid{k}\comp \succ }\mathrel{=}\alt{\underline{\mathrm{1}}}{\Varid{mul}\;\conj{\Varid{f}\;\Varid{k}}{\Varid{l}\;\Varid{k}}}}
...
%
        \ensuremath{\begin{lcbr}\Varid{g}\comp \underline{\mathrm{0}}\mathrel{=}\underline{\mathrm{1}}\\\Varid{g}\comp \succ \mathrel{=}\Varid{mul}\;\conj{\Varid{g}}{\Varid{s}}\end{lcbr}}
\just\equiv{ Eq-+ }
%
\ensuremath{\alt{\Varid{g}\comp \underline{\mathrm{0}}}{\Varid{g}\comp \succ }\mathrel{=}\alt{\underline{\mathrm{1}}}{\Varid{mul}\;\conj{\Varid{g}}{\Varid{s}}}}
\just\equiv{ Fusão-+,in = [\underline{0}, succ], Absorção-+}
%
...
\just\equiv{ Igualdade extensional, Cancelamento-x }
%
        \ensuremath{\begin{lcbr}\Varid{s}\comp \underline{\mathrm{0}}\mathrel{=}\underline{\mathrm{1}}\\\Varid{s}\comp \succ \mathrel{=}\succ \comp \p2\comp \conj{\Varid{g}}{\Varid{s}}\end{lcbr}}
\just\equiv{ Eq-+ }
%
...
\just\equiv{ Fokkinga }
%
\ensuremath{\conj{\Varid{f}\;\Varid{k}}{\Varid{l}\;\Varid{k}}\mathrel{=}\Varid{cata}\;\conj{\alt{\underline{\mathrm{1}}}{\Varid{mul}}}{\alt{\succ \comp \Varid{k}}{\succ \comp \p2}}}
\end{eqnarray*}
...
\just\equiv{ Fokkinga }
%
\ensuremath{\conj{\Varid{g}}{\Varid{s}}\mathrel{=}\Varid{cata}\;\conj{\alt{\underline{\mathrm{1}}}{\Varid{mul}}}{\alt{\underline{\mathrm{1}}}{\succ \comp \p2}}}
\end{eqnarray*}
Combinação dos resultados:
\begin{eqnarray*}
\start
\ensuremath{\Varid{cata}\;(((\alt{\underline{\mathrm{1}}}{\Varid{mul}},\alt{\succ \comp \Varid{k}}{\succ \comp \p2})\times(\alt{\underline{\mathrm{1}}}{\Varid{mul}},\alt{\underline{\mathrm{1}}}{\succ \comp \p2}))\comp \conj{\Conid{F}\;\p1}{\Conid{F}\;\p2})}
%
\just\equiv{ Ff = (id + f); Absorção-x }
%
\ensuremath{\Varid{cata}\;\conj{(\alt{\underline{\mathrm{1}}}{\Varid{mul}},\alt{\succ \comp \Varid{k}}{\succ \comp \p2})\comp (\Varid{id}\mathbin{+}\p1)}{(\alt{\underline{\mathrm{1}}}{\Varid{mul}},\alt{\underline{\mathrm{1}}}{\succ \comp \p2})\comp (\Varid{id}\mathbin{+}\p2)}}
%
\just\equiv{ Fusão-x }
%
\ensuremath{\Varid{cata}\;\conj{(\alt{\underline{\mathrm{1}}}{\Varid{mul}}\comp (\Varid{id}\mathbin{+}\p1),\alt{\succ \comp \Varid{k}}{\succ \comp \p2})\comp (\Varid{id}\mathbin{+}\p1)}{(\alt{\underline{\mathrm{1}}}{\Varid{mul}}\comp (\Varid{id}\mathbin{+}\p2),\alt{\underline{\mathrm{1}}}{\succ \comp \p2})\comp (\Varid{id}\mathbin{+}\p2)}}
%
\just\equiv{ Absorção-+ (x4); Natural-id (x2) }
%
\ensuremath{\Varid{cata}\;\conj{(\alt{\underline{\mathrm{1}}}{\Varid{mul}\comp \p1},\alt{\succ \comp \Varid{k}}{\succ \comp \p2\comp \p1})}{(\alt{\underline{\mathrm{1}}}{\Varid{mul}\comp \p2},\alt{\underline{\mathrm{1}}}{\succ \comp \p2\comp \p2})}}
\end{eqnarray*}
Dedução de base e loop:
\begin{eqnarray*}
\start
\ensuremath{\mathsf{for}\ \Varid{loop}\ \Varid{base}\mathrel{=}\Varid{cata}\;\conj{\alt{\underline{\mathrm{1}}}{\Varid{mul}\comp \p1},\alt{\succ }{\succ \comp \p2\comp \p1}}{\alt{\underline{\mathrm{1}}}{\Varid{mul}\comp \p2},\alt{\underline{\mathrm{1}}}{\succ \comp \p2\comp \p2}}}
%
\just\equiv{ for b i = cata ([\underline{i},b]); Lei da troca (x3) }
%
\ensuremath{\Varid{cata}\;\alt{\underline{\Varid{base}}}{\Varid{loop}}\mathrel{=}\Varid{cata}\;\alt{\conj{\conj{\underline{\mathrm{1}}}{\succ }}{\conj{\underline{\mathrm{1}}}{\underline{\mathrm{1}}}}}{\conj{\conj{\Varid{mul}\comp \p1}{\succ \comp \p2\comp \p1}}{\conj{\Varid{mul}\comp \p2}{\succ \comp \p2\comp \p2}}}}
%
\just\equiv{ cata f = cata g => f = g; Ep-+ }
%
        \ensuremath{\begin{lcbr}\underline{\Varid{base}}\mathrel{=}\conj{\conj{\underline{\mathrm{1}}}{\succ }}{\conj{\underline{\mathrm{1}}}{\underline{\mathrm{1}}}}\\\Varid{loop}\mathrel{=}\conj{\conj{\Varid{mul}\comp \p1}{\succ \comp \p2\comp \p1}}{\conj{\Varid{mul}\comp \p2}{\succ \comp \p2\comp \p2}}\end{lcbr}}
\end{eqnarray*}
...
\column{15}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mbox{\onelinecomment inFTree (Left a) = Unit a}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment inFTree (Right (a,(b,c))) = Comp a b c}{}\<[E]%
\\
...
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  generatePTree}{}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  drawPTree}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  mudar nomes de funções auxiliares}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  usar mais os combinadores nas funções de mais alto nível}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{drawPTreeAux}\;\Varid{x}\;\Varid{pos}\;\Varid{dir}\;(\Conid{Unit}\;(\Varid{a},\Varid{n}))\mathrel{=}[\mskip1.5mu \Varid{mkSquare}\;\Varid{x}\;\Varid{n}\;\Varid{a}\;\Varid{pos}\;\Varid{dir}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{drawPTreeAux}\;\Varid{x}\;\Varid{pos}\;\Varid{dir}\;(\Conid{Comp}\;(\Varid{a},\Varid{n})\;\Varid{e}\;\Varid{d})\mathrel{=}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}[\mskip1.5mu \Varid{mkSquare}\;\Varid{x}\;\Varid{n}\;\Varid{a}\;\Varid{pos}\;\Varid{dir}\mskip1.5mu]\plus {}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}(\Varid{drawPTreeAux}\;\Varid{x}\;\Varid{newPos1}\;\Varid{newDir1}\;\Varid{e})\plus {}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}(\Varid{drawPTreeAux}\;\Varid{x}\;\Varid{newPos2}\;\Varid{newDir2}\;\Varid{d}){}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{mkSquare}\;\Varid{max\char95 n}\;\Varid{n}\;\Varid{a}\;(\Varid{x},\Varid{y})\;\Varid{dir}\mathrel{=}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{drawPTreeAux2}\;\Varid{x}\mathrel{=}(\Varid{\Conid{Graphics}.\Conid{Gloss}.scale}\;\mathrm{50.0}\;\mathrm{50.0})\comp \Varid{pictures}\comp (\Varid{drawPTreeAux}\;\Varid{x}\;(\mathrm{0.0},\mathrm{0.0})\;(\mathrm{0.0},\mathrm{1.0}))\comp \Varid{tagPTree}\;\mathrm{0}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;(\Varid{animation},\anonymous )\mathrel{=}\mathsf{for}\ \Varid{body}\ ([\mskip1.5mu \Varid{f}\;\mathrm{0}\mskip1.5mu],\mathrm{0})\;(\Varid{depthFTree}\;\Varid{t}){}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{f}\;\Varid{x}\mathrel{=}\Varid{drawPTreeAux2}\;\Varid{x}\;\Varid{t}{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
