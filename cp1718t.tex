...
Para desenhar a árvore de Pitágoras como uma animação, é preciso construir a lista de imagens em que cada imagem é um frame da animação. Isto é feito através de um ciclo for (um catamorfismo) cujo corpo é uma função que recebe a lista da animação já construida e o número do próximo frame a incluir nessa lista.
...
\\
\>[B]{}\Varid{dist}\;\Varid{a}\mathrel{=}\Varid{sumProb}\;\Varid{a}\;(\Varid{numberMarbles}\;\Varid{a}){}\<[E]%
>>>>>>> 6af65e06e8e3401e48bbebfaae0a8050e195e214
\ColumnHook
\end{hscode}\resethooks
